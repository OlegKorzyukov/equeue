...
$__smtp = array(
    ...
    "mail_title" => 'Підтвердження пошти', // Заголовок письма
    "mail_name" => 'ВИКОНАВЧИЙ КОМІТЕТ РАЙОННОЇ РАДИ', // Имя отправителя
    "add_address" => $email,
    "msg_mail_form" => 'Ваш код для підтвердження запису на прийом - '.$code_mail
); 
...
try{
    ...
    $mail->SetFrom($__smtp['username'], 'ВИКОНАВЧИЙ КОМІТЕТ РАЙОННОЇ РАДИ');  // Адресант почтового сообщения
